...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onCardClick }) => {
  return (
    // Mengubah div menjadi button untuk aksesibilitas yang lebih baik
    <button
      onClick={onCardClick}
      className="bg-white rounded-lg shadow-md border border-slate-200 overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 group text-left w-full h-full flex flex-col"
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto w-full text-center px-4 py-2 bg-sky-50 text-sky-700 font-semibold rounded-md group-hover:bg-sky-100 transition-colors">
            View Details
        </div>
      </div>
    </button>
